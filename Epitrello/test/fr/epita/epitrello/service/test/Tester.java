package fr.epita.epitrello.service.test;
 ...
 * @version 1.0
 * 
 *This class is used to test the functionality of the Epitrello and save the output in the test file location mentioned in configuration file.
...
public static void main(String[] args) throws Exception {
		...
		logger.log("Start of Test class");

		PrintStream fileOut = new PrintStream(new FileOutputStream(Configuration.getValue("test.file"), false));
		...
		System.out.println( dataserverice.addUser("Prashanth") );
	    ...
	    System.out.println( dataserverice.printAllUnfinishedTasksByPriority() );
	    System.out.println( dataserverice.deleteList("Code") );
	    System.out.println( dataserverice.printAllLists() );
	    System.out.println( dataserverice.printUsersByWorkload() );
